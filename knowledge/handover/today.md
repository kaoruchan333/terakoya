...
### スマホClaude Codeからひみを呼び出す試み
- スマホのclaude.ai/codeからterakoyaプロジェクトに接続してひみと会話できることを確認
- スマホひみでできること：記事作成・ファイル保存・ナレッジ参照
- スマホひみでできないこと：note自動投稿・SNS投稿・Googleカレンダー連携（APIキーがパソコンのcc boosterにしかないため）
- freeeを会計ソフトとして導入することを検討・本人がダウンロードして試す予定

### note下書き作成（人間交差点）
- `content/drafts/2026-04-22-人間交差点-ジガ君が静かだった日のこと.md` を作成
- テーマ：命の巡礼WayOfLife打ち合わせ・ご住職来訪・ジガ君が静かだった体験
- terakoyaリポジトリに保存済み・公開はかおるちゃんがnoteにコピペして行う
